...
class Asset
{
  ...
  protected $alias = [
    ...
    '@jquery-ui' => [
      'js' => '@admin/dcat/plugins/jquery-ui/jquery-ui.min.js',
      'css' => '@admin/dcat/plugins/jquery-ui/jquery-ui.min.css',
    ],
    '@blockui' => [
      'js' => '@admin/dcat/plugins/blockui/jquery.blockUI.js',
      'css' => '@admin/dcat/plugins/blockui/sprinner.css',
    ],
  ];
